...
Entrance doors RFI901-SPEC-E-A-690 these works can only be completed once door operting units are installed by others.

Lift T\&C still pending delays by KONE.

Interfacing with ACS to be completed once ACS is operating.
\end{update}
...
Oustanding material orders have been held-up due to delays in amending the L/C. Table\ref{faorders} shows the outstanding deliveries. \hl{All items now delivered, with the exception of the Fire Ventilation panels, which are expected to arrive before 30 April 2013.}
\vspace*{1cm}
