...
\ganttbar[color=orange]{Physical completion   \protect{[\ref{g:test}}] }{0}{2}
\ganttbarcon[color=orange]{Hydrotest}{2}{0.2}
\ganttbarcon[color=orange]{Snagging}{2.2}{0.5}
\ganttbar[color=orange]{Electrical}{2}{2}
\ganttbar[color=orange]{Podium Completion}{1}{4}
\ganttbar[color=orange]{Flushing}{1}{4}
\ganttbarcon[color= orange]{Qatar Cool Inspection}{3}{4}
\ganttbarcon[color=orange]{Qatar Cool connection}{9}{1.3}
\ganttbarcon[color=orange]{Operate}{12}{1.3}
\ganttbarcon[color=red]{Handover}{14}{2}
