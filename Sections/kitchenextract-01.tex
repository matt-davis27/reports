...
\setcounter{step}{0}
\captionof{table}[Rotana stainless steel ductwork status.]{Rotana, status of  works for stainless steel extract ductwork.\textcircled{1} ducting installation, \textcircled{2} insulation, \textcircled{3} fan installation, \textcircled{4} fan connection, \textcircled{5} electrical, \textcircled{6} Testing and Commissioning.}
\begin{activitytable}
...
\setcounter{step}{0}
\captionof{table}[Shangrila stainless steel ductwork status.]{Shangrila, status of  works for stainless steel extract ductwork. \textcircled{1} ducting installation, \textcircled{2} insulation, \textcircled{3} fan installation, \textcircled{4} fan connection, \textcircled{5} electrical, \textcircled{6} Testing and Commissioning.}
\begin{activitytable}
...
\setcounter{step}{0}
\captionof{table}[Merweb stainless steel ductwork status.]{Merweb, status of  works for stainless steel extract ductwork. \textcircled{1} ducting installation, \textcircled{2} insulation, \textcircled{3} fan installation, \textcircled{4} fan connection, \textcircled{5} electrical, \textcircled{6} Testing and Commissioning.}
\begin{activitytable}
7    & &&&&&&\\
...
\setcounter{step}{0}
\captionof{table}[Rotana ECUs status.]{Rotana, status of  works for stainless steel extract ductwork.\textcircled{1} Tag \textcircled{2} installation, \textcircled{3}hood connection, \textcircled{4}electrical, \textcircled{5} bms, \textcircled{6} Testing and Commissioning.}
\begin{ECUtable}
