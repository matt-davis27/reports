...
\item \textit{Access Control System}. This only partially affects the Civil Defence Inspection. We expect this to be completed before the 15 May 2013, provided design issues with Control Room\sidenote{Engineer has still not confirmed CCTV related changes} are cleared and all Civil works completed. All doors need to be installed and areas to be clear of any dust creating activities before Commissioning and final device installation.
