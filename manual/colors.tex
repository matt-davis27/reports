...
The |xcolor| package provides numerous macros for typesetting colors, using a variety of methods and color schemes. For example we can use the command \pmac{xcolor}{color} to print a text sample in color.
\newlength\pull
