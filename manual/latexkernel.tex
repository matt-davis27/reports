...
%\input{./manual/kernel-h-ltpar.tex} Paragraphs
%\label{pars}
%\input{kernel-i-ltspace.tex}\label{spc}

%\input{./manual/kernel-F-ltsec}   Sectioning
%\input{./manual/kernel-d-ltxdefns.tex} Definitions
%\input{./manual/kernel-d-ltxdefns.tex}
%\input{./manual/kernel-N-ltlength.tex}\ref{kernel:lengths}
