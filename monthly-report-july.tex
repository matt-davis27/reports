...
\documentclass[a4paper, oneside, 
               justified=true, sfsidenotes, 12pt]{tufte-book} 
...
\title{CLOSURE \\AND\\COMMISSIONING\\REPORT FOR MEP}
\author{Habtoorisland}
\publisher{Habtoor Leighton Specon llc}
\date{13 July 2013} % Delete this line to display the current date
